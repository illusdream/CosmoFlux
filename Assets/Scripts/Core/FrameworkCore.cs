...
namespace ilsFramework.Core
{
    public class FrameworkCore : Singleton<FrameworkCore>
    {
        ...
        public Action AfterAllManagerInitialized;
        ...
        public IEnumerator Initialize()
        {
            ...
            yield return AssemblyForeach();
            Debug.Log("FrameworkCore Initialized");
            ...
            AfterAllManagerInitialized?.Invoke();
            "框架初始化完成".LogSelf();
            ThrowAllExceptions();
        }
        ...
        ///     程序集遍历
        /// </summary>
        private IEnumerator AssemblyForeach()
        {
            ...
            foreach (var manager in allManagers)
            {
                ...
                yield return manager.Item1.Init();
            }
            ...
            foreach (var iAssemblyForeach in list)
            {
                try
                {
                    iAssemblyForeach.ForeachCurrentAssembly(types.ToArray());
                }
                catch (Exception e)
                {
                    exceptions.Add(e);
